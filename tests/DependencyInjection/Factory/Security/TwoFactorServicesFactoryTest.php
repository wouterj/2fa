...
class TwoFactorServicesFactoryTest extends TestCase
{
     ...
     * @test
     */
    public function getCsrfTokenManagerId_defaultSettings_useDefaultCsrfManager(): void
    {
        $returnValue = $this->servicesFactory->getCsrfTokenManagerId(self::DEFAULT_CONFIG);
     ...
     * @test
     */
    public function getCsrfTokenManagerId_csrfManagerConfigured_useCustomCsrfManager(): void
    {
        $returnValue = $this->servicesFactory->getCsrfTokenManagerId(['csrf_token_generator' => 'my_csrf_token_manager']);
        $this->assertEquals('my_csrf_token_manager', $returnValue);
    }
